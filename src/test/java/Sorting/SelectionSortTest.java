...
public class SelectionSortTest {
    ...
    public void InsertionSortT(){
        ...
        assertArrayEquals(res1.toArray(), ss.SelectionSort(exm1).toArray());


        // Test Path [1,2,3,4,5,6,7,4,9,2,10,11]
        ...
        // Test Path [1,2,3,4,5,6,7,4,5,8,7,4,9,2,10,11]
        ...
        assertArrayEquals(res3.toArray(), ss.SelectionSort(exm3).toArray());
    }
}
